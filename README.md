...
#### Integrated with ELVON Clinical Intelligence & Audit Enclave Platform

[![Python](https://img.shields.io/badge/Python-3.10%2B-blue.svg)](https://www.python.org/)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.110%2B-009688.svg)](https://fastapi.tiangolo.com/)
[![Next.js](https://img.shields.io/badge/Next.js-16.2-black.svg)](https://nextjs.org/)
[![Quantum](https://img.shields.io/badge/QML-Ideal%20%26%20Noisy%20Simulators-indigo.svg)](#)
[![Security](https://img.shields.io/badge/Enclave-Zero--Data--Leakage-emerald.svg)](#)

This platform provides a complete **Hybrid Quantum-Classical Machine Learning Platform for Early Disease Detection** (Problem Statement ID: 26139) alongside the ELVON clinical intelligence enclave. It implements:
- **Biomedical Data Pipeline**: Strict 70/15/15 train/val/test data leakage prevention, domain-aware clinical feature engineering, and PCA dimensionality reduction to 4–12 quantum-compatible qubits.
- **Classical ML Baselines**: Logistic Regression, Support Vector Machine (RBF), Random Forest, XGBoost / Gradient Boosting, and Neural Network (MLP).
- **Quantum Machine Learning Models**: Quantum Kernel Classifier (QSVM), Variational Quantum Classifier (VQC with parameterized ansatz), and Quantum Neural Networks (QNN).
- **Dual Quantum Execution**: Ideal Statevector Simulator and Noisy NISQ Simulator (depolarizing + readout error) with near-term hardware readiness scoring.
- **Explainable AI (XAI)**: Perturbation-based quantum sensitivity analysis ($\Delta \langle Z \rangle$) and PCA component-to-clinical feature attribution.
- **Interactive SIH 11-Step Demo Suite**: Available at `/quantum-lab` with real-time benchmarking, live patient prediction, and exportable experimental reports.
...
- **Python 3.10+**
- **Node.js 18+** & npm
- (Optional) PostgreSQL 14+ (or runs in local fallback mode)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Nehal848/neural-audit-enclave.git
   cd neural-audit-enclave
   ```
...
4. **Configure Environment Variables:**
   ...
   cp .env.example .env
   ```
   *(Optionally add your `GEMINI_API_KEY` for AI-assisted clinical report generation).*
...
The platform comes pre-seeded with sandbox credentials for immediate testing:

| Role | Identifier / Registration | Password | Access Area |
|---|---|---|---|
| **Doctor / Clinician** | `MED-11001-DL` | `doctor` | Doctor Portal, Patient Triage, Lab Analysis |
| **Hospital Admin** | `HOSP-MH-001` | `admin` | Command Center, AutoML Pipeline, Model Marketplace |

*(In demo mode, OTP verification displays directly on the UI or console).*

---

### 5. Run Automated Verification Tests

To verify all 13 steps of the AutoML tournament, clinical auth, and API routes:
```bash
