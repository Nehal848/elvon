  ...
  return (
    ...
    >
      <form onSubmit={handleSaveSettings} className="space-y-6 max-w-5xl">
        {savedSuccess && (
          <div className="bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 px-4 py-3 rounded-2xl flex items-center gap-2 text-sm">
            <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
            Settings saved successfully! Updating session profile...
          </div>
        )}
        ...
        <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h2 className="text-base font-bold text-white">Researcher Profile & Persona Role</h2>
              <p className="text-xs text-slate-400">Configure your identity and view mode across the platform</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Active Persona Role</label>
              <select
                value={userRole}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Affiliated Institution</label>
              <input
                type="text"
                value={organization}
        ...
        <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h2 className="text-base font-bold text-white">Quantum Computing Execution Target</h2>
              <p className="text-xs text-slate-400">Configure Qiskit / PennyLane simulator engine and NISQ physical hardware</p>
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm mb-5">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Simulation Backend</label>
              <select
                value={activeBackend}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Measurement Shots</label>
              <select
                value={shots}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Qiskit Transpiler Level</label>
              <select
                value={optLevel}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1.5">IBM Quantum Experience API Token</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 text-sm font-mono"
              />
            </div>
            <p className="text-[11px] text-slate-400 mt-1">
        ...
        <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h2 className="text-base font-bold text-white">Zero-Data-Leakage & Governance</h2>
              <p className="text-xs text-slate-400">Strict clinical research validation safeguards</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm">
            <div className="flex items-center justify-between p-3 bg-slate-900/60 rounded-xl border border-slate-700/40">
              <div>
                <div className="font-semibold text-white">Strict Split Data Leakage Verification</div>
            ...
            <div className="flex items-center justify-between p-3 bg-slate-900/60 rounded-xl border border-slate-700/40">
              <div>
                <div className="font-semibold text-white">NISQ Noise Simulation Layer</div>
                <div className="text-xs text-slate-400">
            ...
            <div className="flex items-center justify-between p-3 bg-slate-900/60 rounded-xl border border-slate-700/40">
              <div>
                <div className="font-semibold text-white">Differential Privacy (DP-SGD)</div>
                <div className="text-xs text-slate-400">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <button
            type="submit"
            className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold rounded-xl transition flex items-center gap-2 shadow-lg shadow-indigo-600/30"
          >
